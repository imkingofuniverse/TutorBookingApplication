...
function PUpdatedetails(){
  ...
  function usersignup(){
    ...
    axios.post("http://localhost:9090/parent/updateParent",resbody).then((res)=>console.log(" Registration successfull"));
  }
  ...
  return(
    ...
    <div className="supc">
      ...
      <br/>
      <div className="submitbutton">
       <button type="submit" onClick={registrationdone}>UPDATE</button>
      </div>
    </div>
    </div>
  );
}
export default PUpdatedetails;